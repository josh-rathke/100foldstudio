 ...
 * Mobile off-canvas
 */
if ( ! function_exists( '_100foldstudio_mobile_off_canvas' ) ) {
	function _100foldstudio_mobile_off_canvas() {
	    wp_nav_menu(array(
	        'container' => false,                           // Remove nav container
	        'container_class' => '',                        // Class of container
	        'menu' => '',                                   // Menu name
	        ...
	        'depth' => 5,                                   // Limit the depth of the nav
	        'fallback_cb' => false,                         // Fallback function (see below)
	        'walker' => new _100foldstudio_Offcanvas_Walker(),
	    ));
	}
}
...
*/
if ( ! function_exists( '_100foldstudio_add_menuclass' ) ) {
	function _100foldstudio_add_menuclass($ulclass) {
	    $find = array('/<a rel="button"/', '/<a title=".*?" rel="button"/');
	    $replace = array('<a rel="button" class="button"', '<a rel="button" class="button"');

	    return preg_replace( $find, $replace, $ulclass, 1 );
	}
	add_filter( 'wp_nav_menu','_100foldstudio_add_menuclass' );
}
 ...
 */
function _100foldstudio_breadcrumb($showhome = true, $separatorclass = false) {
